...
def test_backends_functions_list_function_space(
...
def test_backends_functions_list_comm(functions_list: rbnicsx.backends.FunctionsList[dolfinx.typing.Scalar]) -> None:
    """Check rbnicsx.backends.FunctionsList.comm."""
    assert functions_list.comm == functions_list[0].function_space.mesh.comm


def test_backends_functions_list_duplicate(
    functions_list: rbnicsx.backends.FunctionsList[dolfinx.typing.Scalar]
) -> None:
...
def test_backends_functions_list_extend(functions_list: rbnicsx.backends.FunctionsList[dolfinx.typing.Scalar]) -> None:
...
def test_backends_functions_list_len(functions_list: rbnicsx.backends.FunctionsList[dolfinx.typing.Scalar]) -> None:
    """Check rbnicsx.backends.FunctionsList.__len__."""
    assert len(functions_list) == 2


def test_backends_functions_list_clear(functions_list: rbnicsx.backends.FunctionsList[dolfinx.typing.Scalar]) -> None:
    """Check rbnicsx.backends.FunctionsList.clear."""
    functions_list.clear()
    assert len(functions_list) == 0


def test_backends_functions_list_iter(functions_list: rbnicsx.backends.FunctionsList[dolfinx.typing.Scalar]) -> None:
...
def test_backends_functions_list_getitem_int(
    functions_list: rbnicsx.backends.FunctionsList[dolfinx.typing.Scalar]
) -> None:
...
def test_backends_functions_list_getitem_slice(
    functions_list: rbnicsx.backends.FunctionsList[dolfinx.typing.Scalar]
) -> None:
...
def test_backends_functions_list_getitem_wrong_type(
    functions_list: rbnicsx.backends.FunctionsList[dolfinx.typing.Scalar]
) -> None:
...
def test_backends_functions_list_setitem(functions_list: rbnicsx.backends.FunctionsList[dolfinx.typing.Scalar]) -> None:
...
def test_backends_functions_list_save_load(
    functions_list: rbnicsx.backends.FunctionsList[dolfinx.typing.Scalar]
) -> None:
...
def test_backends_functions_list_mul(functions_list: rbnicsx.backends.FunctionsList[dolfinx.typing.Scalar]) -> None:
...
def test_backends_functions_list_mul_empty(mesh: dolfinx.mesh.Mesh[dolfinx.typing.Real]) -> None:
...
def test_backends_functions_list_mul_not_implemented(
    functions_list: rbnicsx.backends.FunctionsList[dolfinx.typing.Scalar]
) -> None:
